// ManiDine.ca — FILE: /app/stripe-refresh/page.tsx — Updated: 2026-04-04 09:00 AM (America/Edmonton)
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/stripe-refresh" },
};
          ...
          <div className="mx-auto max-w-[760px] text-center">
            ...
            <div className="mt-8 rounded-2xl bg-white/6 p-5 text-left ring-1 ring-white/10">
              <p className="text-[15px] font-semibold text-white md:text-[16px]">
                Typical reasons you may see this page
              </p>
            ...
            <p className="mt-6 text-[13.5px] text-white/55">
              This utility page is used only for Stripe onboarding refresh flow.
            </p>
          </div>
        </div>
      </div>
