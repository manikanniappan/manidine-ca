// ManiDine.ca / (project root) / app/restaurants/page.tsx — Updated: 2026-05-07 09:50 (America/Edmonton)
  ...
  return (
    <main style={pageWrap}>
      ...
      <section style={grid}>
        ...
        />
        <Card
          title="Only pay membership when you earn"
          desc="The monthly membership is 10% of ManiDine sales, capped at $200/month, and only applies when the restaurant receives sales through ManiDine."
        />
      </section>
      ...
      <section style={boxHighlight}>
        ...
        <div style={pricingGrid}>
          ...
          <div style={priceCard}>
            <div style={priceLabel}>Monthly membership</div>
            <div style={priceValue}>10%</div>
            <p style={priceText}>
              Only on sales generated by ManiDine, capped at $200/month.
            </p>
          </div>
        ...
        <div style={exampleBox}>
          ...
          ManiDine brings $5,000 in monthly sales, the membership fee is capped at
          $200 for that month. If ManiDine brings no sales, there is no monthly
          membership fee.
        </div>
      </section>
      ...
      <section style={box}>
        ...
        <ul style={list}>
          ...
          <li>Clear monthly membership: 10% of ManiDine sales, capped at $200/month</li>
